...
#SBATCH -J gpt_code_multi-task_train         # Job name
#SBATCH -o /work/07010/sgarg/maverick2/nlp_project/transformers/examples/training_logs/gpt-cose-multi_train.out       # Specify stdout output file (%j expands to jobId)
